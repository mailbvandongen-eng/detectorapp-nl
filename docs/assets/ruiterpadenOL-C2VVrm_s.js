import{V as d,c as u,k as p,F as f,l as h,S as g,d as y}from"./index-3k16z6_u.js";const i="ruiterpaden_cache",m=10080*60*1e3;async function w(){try{const e=localStorage.getItem(i);if(e){const{timestamp:o,data:a}=JSON.parse(e);if(Date.now()-o<m)return console.log(`✓ Ruiterpaden loaded from cache (${a.length} trails)`),a}}catch{}const r=`
    [out:json][timeout:90];
...
//# sourceMappingURL=ruiterpadenOL-C2VVrm_s.js.map
