const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-BcIR7vDC.js","assets/index-BWVNpxIg.js","assets/index-CPmREwGj.css","assets/HUDMaterial.glsl-FlE5zuB3.js","assets/meshVertexSpaceUtils-BAfY6V7n.js","assets/MeshLocalVertexSpace-OxkOElBT.js","assets/hydratedFeatures-o4UZQBND.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-CE13TL-j.js","assets/Indices-CIjKtfVD.js","assets/BufferView-BhR_875o.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-Cxn2zK_P.js","assets/orientedBoundingBox-DCv9Ykdm.js","assets/quat-CsBYo5vL.js","assets/computeTranslationToOriginAndRotation-BOHDDM_s.js","assets/VertexAttributeLocations-BfZbt_DV.js","assets/VertexElementDescriptor-BLyltQyJ.js","assets/InterleavedLayout-B2Jk6eEy.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-D-E53mPP.js"])))=>i.map(i=>d[i]);
import{kK as ze,a7 as x,br as W,aq as $e,lG as et,dp as At,gu as Dt,jb as Gt,aB as V,ki as jt,zq as Bt,ti as Ht,mk as kt,zr as tt,bM as c,bN as H,bO as at,zs as Wt,zt as Ut,lz as Q,aJ as ot,ly as Fe,kq as Ge,kg as Yt,oJ as qt,zu as U,_ as he,a5 as rt,mj as ne,e4 as re,fE as Zt,fF as Xt,fU as Jt,cG as Kt,lU as Qt,c9 as ea,bf as z,g4 as ta,je as aa,ah as oa,af as ra,aT as ia,ay as be,al as na,av as je,ak as sa,ke as la}from"./index-BWVNpxIg.js";import{a6 as E,i as me,d as pe,a7 as I,a as it,a8 as fe,a9 as nt,aa as st,ab as ca,ac as k,ad as da,ae as ua,af as ha,f as ma,ag as J,r as O,a2 as ae,D as A,E as D,ah as G,G as K,b as y,I as j,ai as pa,H as fa,aj as va,ak as lt,q as se,al as ct,o as dt,am as ut,g as ga,j as Ne,k as ve,s as ht,an as xa,ao as ba,u as wa,v as Be,ap as ya,aq as _,ar as Oe,as as Ma,at as Ta,c as ee,au as _a,X as oe,av as Sa,M as Ca,aw as mt,ax as le,F as pt,L as ft,K as vt,ay as gt,J as xt,N as za,T as $a,O as Fa,P as Na,Q as Oa,R as Ia,U as La,V as Va,W as Ea,Y as Ra,x as m,A as Pa,az as we,aA as ye,a1 as Aa,aB as Da,B as Ga,aC as ja,a3 as Ba,aD as Ha}from"./OutputColorHighlightOID.glsl-CE13TL-j.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-B2Jk6eEy.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-BhR_875o.js";import{r as ka}from"./VertexBuffer-c6JfFZ-x.js";import{s as ge}from"./ShaderBuilder-D-E53mPP.js";import{T as Le,d as Ve,_ as Wa}from"./renderState-CKc66y4x.js";import{t as Ua}from"./VertexAttributeLocations-BfZbt_DV.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=W();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ca("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Yt(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new k("viewOriginHi",l=>da(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new k("viewOriginLo",l=>ua(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
    ...
    }`)}const ie=x();function St(a,e){a.varyings.add("colorMixMode","int"),a.varyings.add("opacityMixMode","int"),a.vertex.uniforms.add(new ma("symbolColorMixMode",t=>J[t.colorMixMode])),e.hasSymbolColors?(a.vertex.include(fe),a.vertex.include(nt),a.vertex.include(st),a.attributes.add("symbolColor","vec4"),a.vertex.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(co,e),o.include(j,e),a.include(fa,e),va(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(j,e),a.include(B,e),a.include(pa,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`),s&&d!==0&&(a.include(lt,e),t.uniforms.add(n===1?new y("normalTexture",u=>u.textureNormal):new se("normalTexture",u=>u.textureNormal)),l&&(t.uniforms.add(new ct("scale",u=>u.scale??qt)),t.uniforms.add(new I("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??U))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`),a.outputs.add("fragOcclusion","float"),e.uniforms.add(new y("normalMap",t=>t.normalTexture),new y("depthMap",t=>t.depthTexture),new O("projScale",t=>t.projScale),new y("rnm",t=>t.noiseTexture),new ct("rnmScale",(t,o)=>ne(Xe,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new O("intensity",t=>t.intensity),new ba("screenSize",t=>ne(Xe,t.camera.fullWidth,t.camera.fullHeight))).main.add(i`
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function _o(a,e){const t=a.fragment,o=e.lightingSphericalHarmonicsOrder!==void 0?e.lightingSphericalHarmonicsOrder:2;o===0?(t.uniforms.add(new k("lightingAmbientSH0",({lighting:r})=>V(Ke,r.sh.r[0],r.sh.g[0],r.sh.b[0]))),t.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
}`))}const Ke=x(),$=et();function ue(a){a.uniforms.add(new k("mainLightDirection",e=>e.lighting.mainLight.direction))}function te(a){a.uniforms.add(new k("mainLightIntensity",e=>e.lighting.mainLight.intensity))}function So(a){ue(a.fragment),te(a.fragment),a.fragment.code.add(i`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
inputs.diffuseColor = inputs.albedoLinear * (vec3(1.0) - inputs.f0) * (1.0 - inputs.metalness);`),e.useFillLights?t.uniforms.add(new Ma("hasFillLights",n=>n.enableFillLights)):t.constants.add("hasFillLights","bool",!1),t.code.add(i`vec3 ambientDir = vec3(5.0 * groundNormal[1] - groundNormal[0] * groundNormal[2], - 5.0 * groundNormal[0] - groundNormal[2] * groundNormal[1], groundNormal[1] * groundNormal[1] + groundNormal[0] * groundNormal[0]);
...
float occlusion;`),r&&o.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&o.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),o.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new _a("mrrFactors",u=>u.mrrFactors)),o.code.add(i`
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Lt(a){a.include(Ca),a.code.add(i`
