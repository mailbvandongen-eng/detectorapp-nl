import{V as p,c as f,f as g,P as d,g as h,S as y,h as m}from"./index-Dth4aTo1.js";const i="natuurparkeer_cache",w=1440*60*1e3;async function k(){try{const t=localStorage.getItem(i);if(t){const{timestamp:o,data:e}=JSON.parse(t);if(Date.now()-o<w)return console.log(`✓ Natuurparkeerplaatsen loaded from cache (${e.length} locations)`),e}}catch{}const s=`
    [out:json][timeout:60];
...
//# sourceMappingURL=natuurParkeerOL-DVeQeuNS.js.map
