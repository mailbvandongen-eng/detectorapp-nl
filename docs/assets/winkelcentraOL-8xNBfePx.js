import{V as h,c as d,f as p,P as w,g,S as f,h as u}from"./index-FRskwP0A.js";const i="winkelcentra_cache",m=10080*60*1e3;async function k(){try{const t=localStorage.getItem(i);if(t){const{timestamp:s,data:a}=JSON.parse(t);if(Date.now()-s<m)return console.log(`✓ Winkelcentra loaded from cache (${a.length} locations)`),a}}catch{}const o=`
    [out:json][timeout:60];
...
//# sourceMappingURL=winkelcentraOL-8xNBfePx.js.map
