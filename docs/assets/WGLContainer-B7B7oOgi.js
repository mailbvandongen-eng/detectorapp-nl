import{jz as A,X as M,ct as at,k0 as Ne,jC as le,nT as ee,s9 as rt,qT as ce,sa as st,jB as lt,jD as ct,jF as ft,jE as ut,jy as k,pL as dt,fH as _t,id as vt,o4 as ht,sb as mt,a1 as H,nN as pe,sc as gt,cz as oe,nR as Fe,Y as ve,sd as pt,se as yt,sf as xt,sg as St,c_ as Tt,d0 as It,a5 as bt,sh as N,si as Be,jH as ye,aF as Et,aE as Ot,sj as xe,sk as At,fi as Se,s as Ue,mk as Pt,jZ as Mt,gR as Te,de as Ct,sl as Lt}from"./index-CH40XmCz.js";import{$ as zt,d as Ie,f as Dt,g as Ye,s as z,t as Rt,n as q,e as X,h as Ge}from"./Utils-Bs9vcvRC.js";import{e as Vt,a as te}from"./ProgramTemplate-C1h4-OCV.js";import{h as $}from"./VertexArrayObject-CRShnJBq.js";import{n as wt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-B0FWiFoG.js";import{n as Nt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Ft}from"./Container-DOCZIlsX.js";import{o as fe}from"./BufferObject-1OGpYKtr.js";import{e as be}from"./config-BOD8--da.js";import{e as Bt}from"./earcut-D9gy186-.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-B7B7oOgi.js.map
