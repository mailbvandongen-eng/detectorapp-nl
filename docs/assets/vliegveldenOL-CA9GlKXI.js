import{G as i}from"./GeoJSON-DzryzwP6.js";import{M as o,G as r,H as n,a1 as s}from"./index-WTSpnFHA.js";async function w(){try{const e=await fetch("/detectorapp-nl/data/military/vliegvelden.geojson");if(!e.ok)throw new Error("Failed to load vliegvelden data");const t=await e.json(),l=new o({features:new i().readFeatures(t,{dataProjection:"EPSG:4326",featureProjection:"EPSG:3857"})}),a=new r({source:l,properties:{title:"Militaire Vliegvelden"},visible:!1,zIndex:34,style:new n({image:new s({src:"data:image/svg+xml,"+encodeURIComponent(`
          ...
          `),scale:1,anchor:[.5,.5]})})});return console.log(`✈️ Militaire Vliegvelden loaded (${t.features.length} locations)`),a}catch(e){return console.error("Failed to load vliegvelden:",e),new r({source:new o,properties:{title:"Militaire Vliegvelden"},visible:!1,zIndex:34})}}export{w as createVliegveldenLayerOL};
//# sourceMappingURL=vliegveldenOL-CA9GlKXI.js.map
