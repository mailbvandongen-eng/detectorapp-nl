import{iS as A,X as M,d3 as at,je as Ne,iV as le,l$ as ee,pm as rt,om as ce,pn as st,iU as lt,iW as ct,iY as ft,iX as ut,iR as k,no as dt,f6 as _t,hO as vt,po as ht,a1 as H,aQ as ge,pp as mt,d8 as oe,lZ as Fe,Y as ve,pq as pt,pr as gt,ps as yt,pt as xt,dv as St,dx as Tt,a4 as It,pu as N,pv as Be,iZ as ye,b3 as bt,b2 as Et,pw as xe,s as Ue,jb as Ot,gm as Se,dI as At,px as Pt}from"./index-Byxx4W8D.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-h-vYNFSd.js";import{e as zt,a as te}from"./ProgramTemplate-Bhk2fQog.js";import{h as $}from"./VertexArrayObject-qbCCGB46.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-Ce69sNK6.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-D7eK5bTM.js";import{n as wt}from"./memoryEstimations-DzbfyWp3.js";import{o as fe}from"./BufferObject-sUPuWhP8.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-CrVerzq1.js";import{e as be}from"./OptimizedFeature-DTBRXDcp.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-m8rkDPz2.js.map
