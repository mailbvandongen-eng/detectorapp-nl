import{V as d,c as u,m as p,F as f,n as h,S as g,d as y}from"./index-Bq3Lh8Um.js";const i="ruiterpaden_cache",m=10080*60*1e3;async function w(){try{const e=localStorage.getItem(i);if(e){const{timestamp:o,data:a}=JSON.parse(e);if(Date.now()-o<m)return console.log(`✓ Ruiterpaden loaded from cache (${a.length} trails)`),a}}catch{}const r=`
    [out:json][timeout:90];
...
//# sourceMappingURL=ruiterpadenOL-CTZcw-Fd.js.map
