import{V as d,c as h,g as p,f as y,L as f,S as g,d as u}from"./index-giZw7zC8.js";const i="laarzenpaden_cache",m=10080*60*1e3;async function w(){try{const a=localStorage.getItem(i);if(a){const{timestamp:s,data:e}=JSON.parse(a);if(Date.now()-s<m)return console.log(`✓ Laarzenpaden loaded from cache (${e.length} trails)`),e}}catch{}const n=`
    [out:json][timeout:90];
...
//# sourceMappingURL=laarzenpadenOL-3WQHx2lU.js.map
