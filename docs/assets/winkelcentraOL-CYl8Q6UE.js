import{V as h,c as d,f as p,P as w,g as f,S as g,h as u}from"./index-DKnLi5TN.js";const i="winkelcentra_cache",m=10080*60*1e3;async function y(){try{const t=localStorage.getItem(i);if(t){const{timestamp:s,data:a}=JSON.parse(t);if(Date.now()-s<m)return console.log(`✓ Winkelcentra loaded from cache (${a.length} locations)`),a}}catch{}const o=`
    [out:json][timeout:60];
...
//# sourceMappingURL=winkelcentraOL-CYl8Q6UE.js.map
