import{V as p,c as f,f as g,P as d,g as h,S as m,h as y}from"./index-CRglREwm.js";const i="natuurparkeer_cache",w=1440*60*1e3;async function k(){try{const t=localStorage.getItem(i);if(t){const{timestamp:o,data:e}=JSON.parse(t);if(Date.now()-o<w)return console.log(`✓ Natuurparkeerplaatsen loaded from cache (${e.length} locations)`),e}}catch{}const s=`
    [out:json][timeout:60];
  ...
  </svg>`)}const u=new Map;function v(s,t){const o=s.get("fee")||"unknown";let e=1;t>150?e=.5:t>75?e=.6:t>40?e=.7:t>20?e=.85:t>10?e=1:e=1.2;const r=`parkeer-${o}-${e.toFixed(2)}`;let a=u.get(r);return a||(a=new m({image:new y({src:b(o),scale:e,anchor:[.5,.5]})}),u.set(r,a)),a}async function S(){const s=new p;let t=!1,o=!1;const e=new f({source:s,properties:{title:"Natuurparkeren",type:"overlay"},visible:!1,style:(r,a)=>v(r,a),zIndex:26});return e.on("change:visible",async()=>{if(e.getVisible()&&!t&&!o){o=!0,console.log("🔄 Natuurparkeren: laden...");const a=(await k()).map(n=>new g({geometry:new d(h([n.lon,n.lat])),name:n.name,fee:n.fee,capacity:n.capacity,access:n.access,surface:n.surface,operator:n.operator,opening_hours:n.opening_hours,natuurgebied:n.natuurgebied}));s.addFeatures(a),t=!0,o=!1,console.log(`✓ Natuurparkeren geladen (${a.length} locaties)`)}}),e}export{S as createNatuurParkeerLayerOL};
//# sourceMappingURL=natuurParkeerOL-BiCtfZ6f.js.map
