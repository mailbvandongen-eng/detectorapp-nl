import{g as d,V as u,w as p,F as f,x as h,S as g,h as y}from"./index-BAJNutu1.js";const i="ruiterpaden_cache",m=10080*60*1e3;async function w(){try{const e=localStorage.getItem(i);if(e){const{timestamp:o,data:a}=JSON.parse(e);if(Date.now()-o<m)return console.log(`✓ Ruiterpaden loaded from cache (${a.length} trails)`),a}}catch{}const r=`
    [out:json][timeout:90];
...
//# sourceMappingURL=ruiterpadenOL-CRx1dD9-.js.map
