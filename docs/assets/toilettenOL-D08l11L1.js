import{V as i,c as h,f,P as g,g as p,S as d,h as u}from"./index-pu7XD9SX.js";const s="toiletten_cache",w=1440*60*1e3;async function m(){try{const e=localStorage.getItem(s);if(e){const{timestamp:c,data:a}=JSON.parse(e);if(Date.now()-c<w)return console.log(`✓ Toiletten loaded from cache (${a.length} locations)`),a}}catch{}const r=`
    [out:json][timeout:30];
...
//# sourceMappingURL=toilettenOL-D08l11L1.js.map
