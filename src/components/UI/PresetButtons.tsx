  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[35px] md:bottom-[40px] left-2 z-[800] w-10 h-10 flex items-center justify-center bg-white/80 hover:bg-white/90 rounded-xl shadow-sm border-0 outline-none transition-colors backdrop-blur-sm"
        title="Instellingen"
      >
      ...
      <button
        onClick={resetAll}
        className="fixed bottom-[80px] md:bottom-[90px] left-2 z-[800] w-10 h-10 flex items-center justify-center bg-white/80 hover:bg-white/90 rounded-xl shadow-sm border-0 outline-none transition-colors backdrop-blur-sm"
      ...
      <button
        ...
        className="fixed bottom-[125px] md:bottom-[140px] left-2 z-[800] w-10 h-10 flex items-center justify-center bg-white/80 hover:bg-white/90 rounded-xl shadow-sm border-0 outline-none transition-colors backdrop-blur-sm"
        title="Presets"
      >
        {presetsPanelOpen ? (
        ...
        {presetsPanelOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-[125px] md:bottom-[140px] left-[52px] bg-white/95 rounded-xl shadow-lg overflow-hidden min-w-[140px] backdrop-blur-sm z-[801]"
            >
